...
function buildPrompt(userPrompt, mode) {
  ...
  return [
    ...
    "- Site context: match the setting the source image implies — dense urban street,",
    "  city skyline backdrop, suburban block, coastal, or rural are all equally valid.",
    "  Keep any surrounding buildings, streets, and footpaths shown in the source.",
    "  If the user brief names a setting (e.g. inner-city, CBD, laneway), follow it.",
    "- Ground plane: realistic and tidy for that setting — paving, street trees, or",
    "  planting at modest scale, never hiding the building. Do not default to bushland",
    "  or heavy vegetation unless the source or brief calls for it.",
    ...
    "",
    "IF ANYTHING IS AMBIGUOUS in the source, choose the PLAIN, CONVENTIONAL reading —",
    "an ordinary Australian building in whatever setting the source implies. Never resolve",
    "ambiguity with a striking or designer feature. A plain wall stays plain.",
    "",
    "The user brief may adjust setting (urban, suburban, coastal, rural), time of day,",
    "season, and material finish quality. It never changes the building's geometry.",
